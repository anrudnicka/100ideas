...
import rudnicka.a.ideas.common.dto.StatisticsDto;
...
public interface QuestionRepository extends JpaRepository<Question, UUID> {
    ...
    @Query(
            value = "select * from questions q order by random() limit :limit", nativeQuery = true)
    List<Question> findRandomQuestions(int limit);

    @Query(
            value = "select new rudnicka.a.ideas.common.dto.StatisticsDto(count (q), count (a)) from Question q join q.answers a")
