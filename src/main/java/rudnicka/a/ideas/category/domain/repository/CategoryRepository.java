package rudnicka.a.ideas.category.domain.repository;
...
public interface CategoryRepository extends JpaRepository<Category, UUID> {
    ...
    @Query(value = "select new rudnicka.a.ideas.category.dto.CategoryWithStatisticsDto(" +
            "c.id, c.name, count(q), count(a)) from Category c " +
