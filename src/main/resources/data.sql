...
insert into questions (id, name, category_id)
values (gen_random_uuid(), 'Jakie są najzdrowsze warzywa?', (select id from categories where name = 'Zdrowie'));

insert into answers (id, name, question_id)
values (gen_random_uuid(), 'Marchewka', (select id from questions where name = 'Jakie są najzdrowsze warzywa?')),
...
insert into answers (id, name, question_id)
values (gen_random_uuid(), 'Gdańsk',
        (select id from questions where name = 'Gdzie najlepiej spędzić wakacje w Polsce')),
       (gen_random_uuid(), 'Bieszczady',
        (select id from questions where name = 'Gdzie najlepiej spędzić wakacje w Polsce')),
       (gen_random_uuid(), 'Mazury',
        (select id from questions where name = 'Gdzie najlepiej spędzić wakacje w Polsce'));
